...
public class UserControllerTests {
    ...
    public void testGetAllUsers() throws Exception {
        ...
        user.setId(1L);
        user.setName("Nikita");
        Page<UserEntity> page = new PageImpl<>(Collections.singletonList(user));
    ...
    public void testUpdateUser() throws Exception {
        ...
        Mockito.when(userService.findById(Mockito.any(Long.class))).thenReturn(user);
        Mockito.when(userService.update(Mockito.any(UserEntity.class), Mockito.eq(user.getId()))).thenReturn(user2);
